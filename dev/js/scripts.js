...
function clouds(){
    ...
    tl.to("#Cloud-1", {duration:15, x:"-=585", ease:"none"}, "same")
    .from("#Cloud-1-2", {duration:15, x:"+=585", ease:"none"}, "same");
    tl.to("#Cloud-2", {duration:15, x:"-=585", ease:"none"}, "same")
    .from("#Cloud-2-2", {duration:15, x:"+=585", ease:"none"}, "same");
    tl.to("#Cloud-3", {duration:15, x:"-=585", ease:"none"}, "same")
    .from("#Cloud-3-2", {duration:15, x:"+=585", ease:"none"}, "same");
    tl.to("#Cloud-4", {duration:15, x:"-=585", ease:"none"}, "same")
    .from("#Cloud-4-2", {duration:15, x:"+=585", ease:"none"}, "same");
    tl.to("#Cloud-5", {duration:15, x:"-=585", ease:"none"}, "same")
    .from("#Cloud-5-2", {duration:15, x:"+=585", ease:"none"}, "same");
    tl.to("#Cloud-6", {duration:15, x:"-=585", ease:"none"}, "same")
    .from("#Cloud-6-2", {duration:15, x:"+=585", ease:"none"}, "same");
}
